...
2026-06-10 | learner | mock-only tool loop limited realistic lab outcomes | bash-backed sandbox tool-node flow enables realistic TODO transformation while preserving the parent-state contract | src/llm_nodes/tool_node_sysbox_bash/ + 5 unit tests green | pending
